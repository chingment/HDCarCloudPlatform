...
{
    public class AddByInsuranceViewModel : BaseViewModel
    {
        ...
        {
            var supplier = CurrentDb.Company.Where(m => m.Status == Enumeration.CompanyStatus.Valid && m.Type == Enumeration.CompanyType.InsuranceCompany).ToList();
            ...
            var category = CurrentDb.ProductCategory.Where(m => m.Id != 1 && m.Id != 1001 && m.IsDelete == false).ToList();
        ...
        public AddByInsuranceViewModel()
        {
