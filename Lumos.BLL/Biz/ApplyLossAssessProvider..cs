...
namespace Lumos.BLL
{
    public class ApplyLossAssessProvider : BaseProvider
    {
        public CustomJsonResult Submit(int operater, OrderToApplyLossAssess orderToApplyLossAssess)
        {
            ...
            using (TransactionScope ts = new TransactionScope())
            {
                ...
                var bizProcessesAudit = BizFactory.BizProcessesAudit.Add(operater, Enumeration.BizProcessesAuditType.ApplyLossAssess, orderToApplyLossAssess.Id);
