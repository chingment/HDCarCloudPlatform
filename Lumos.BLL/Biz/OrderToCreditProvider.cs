    ...
    public class OrderToCreditProvider : BaseProvider
    {
        public CustomJsonResult Submit(int operater, OrderToCredit orderToCredit)
        {
            ...
            using (TransactionScope ts = new TransactionScope())
            {
                ...
                var bizProcessesAudit = BizFactory.BizProcessesAudit.Add(operater, Enumeration.BizProcessesAuditType.OrderToTalentDemand, orderToCredit.Id, Enumeration.AuditFlowV1Status.Submit);
