...
namespace WebBack.Models.Biz.ApplyLossAssess
{
    public class VerifyOrderViewModel : BaseViewModel
    {
        ...
        {
            var bizProcessesAudit = BizFactory.BizProcessesAudit.ChangeApplyLossAssessDealtStatus(this.Operater, id, Enumeration.ApplyLossAssessDealtStatus.InVerifyOrder);
