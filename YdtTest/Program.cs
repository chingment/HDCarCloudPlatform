...
namespace YdtTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var ydtInsCarApiSearch = new YdtInsCarApiSearch(ydtTokenResult.data.token, ydtEmLoginResult.data.session, "粤AT810P");
            //var ydtInsCarApiSearchResult = c.DoGet(ydtInsCarApiSearch);
            ...
            YdtUtils.GetInsCarInfo("粤AT810P");
